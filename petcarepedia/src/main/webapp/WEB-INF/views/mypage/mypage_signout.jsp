				...
				<section id = "section1">
					<div>
						<nav>
							<ul>
								<li>마이페이지</li>
								<li><a href = "http://localhost:9000/petcarepedia/mypage_member_information.do?mid=${mid}">회원 정보</a></li>
								<li><a href = "http://localhost:9000/petcarepedia/mypage_reservation.do?mid=${mid}">예약 내역</a></li>
								<li><a href = "http://localhost:9000/petcarepedia/mypage_my_review.do?mid=${mid}">내가 쓴 리뷰</a></li>
								<li><a href = "http://localhost:9000/petcarepedia/mypage_bookmark.do?mid=${mid}">즐겨찾기</a></li>
								<li><a href = "http://localhost:9000/petcarepedia/mypage_signout.do?mid=${mid}">회원 탈퇴</a></li>
							</ul>
						</nav>
					</div>
				</section>
